...
| Header | Descripción | Método | Ejemplo |
| :--- | :--- | :--- | :--- |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `id` | ID de la biblioteca | asignado | n/a | Respuesta | `"id": "b2488788-2d2a-462b-b1a2-305272777dda"` |
...
| `metadataDescriptors` | Recuento para cada par de valor clave de metadatos de punto de interés único | mixto | n/a | Respuesta |  |
| `poiCountInCities` | Recuento para cada valor de ciudad de punto de interés único | mixto | n/a | Respuesta |  |

## Parámetros de POI

| Parámetro | Descripción | Tipo | Límite | Solicitud o respuesta | Ejemplo |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `data` | Datos de anuncio | Matriz de detalles de puntos de interés | n/a | both |  |
| `id` | ID del punto de interés | asignado | n/a | response | `"id": "1455462b-7f9c-4220-9f42-5bbce777a0d1"` |
...
| `location` | Matriz de tipos y coordenadas de puntos de interés | matriz (mixto) | n/a | both | `"location": {"type": "Point", "coordinates": [-122.201007, 37.604713]` |
...
| `category` | Categoría para el POI | string | 100 caracteres | ambos, opcional* | `"category": "cafe"` |
...
| `lib_id` | ID de la biblioteca en la que está el punto de interés | n/a | n/a | ambas, requerido | `"lib_id": "ac7a0b25-c6c2-43ba-bbc6-2b1777b80fe9"` |
