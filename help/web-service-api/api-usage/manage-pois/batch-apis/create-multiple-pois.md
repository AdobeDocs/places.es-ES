...
# Crear varios POI {#create-multiple-pois}

Método de POST que permite crear varios puntos de interés.
...
>[!IMPORTANT]
>
>Reemplazar `<API KEY>`, `<TOKEN>`, `<ORGID>` y `<PATHTOBATCHCREATEJSONFILE>` por valores reales.

## Archivo JSON de muestra

Este es un ejemplo de archivo JSON para la API `batchCreate`:
