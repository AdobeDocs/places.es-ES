...
# Actualizar varios POI {#update-multiple-pois}

Método de POST que permite actualizar varios puntos de interés.
...
>[!IMPORTANT]
>
>Reemplazar `<API KEY>`, `<TOKEN>`, `<ORGID>` y `<PATHTOBATCHUPDATEJSONFILE>` por valores reales.

## Archivo JSON de muestra

Este es un ejemplo de archivo JSON para la API `batchUpdate`:
