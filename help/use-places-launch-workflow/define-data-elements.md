...
description: Esta sección proporciona información sobre cómo crear, utilizar y publicar elementos de datos en Experience Platform Launch para lugares.
...
# Definir un elemento de datos {#define-data-elements}
...
Un elemento de datos es una variable en la que el valor se puede asignar a un ID de Visitante, un Nombre de operador, un ID de publicidad, un ID de inserción, etc. En Experience Platform Launch, puede hacer referencia a este valor por su nombre de variable. Esta colección de elementos de datos se convierte en el diccionario de datos definidos que se puede utilizar para crear reglas (eventos, condiciones y acciones) y este diccionario se comparte entre Experience Platform Launch, donde se puede utilizar con cualquier extensión de la propiedad.

Con la extensión Places, puede hacer referencia a valores de los siguientes destinatarios:
...
1. Seleccione un destinatario de puntos de interés.
