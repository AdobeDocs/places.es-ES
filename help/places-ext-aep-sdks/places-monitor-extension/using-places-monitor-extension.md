...
## Añadir la extensión del monitor de lugares a la aplicación {#add-monitor-extension-to-app}
...
**[Monitor de lugares de Cordova](https://github.com/adobe/cordova-acpplaces-monitor/blob/master/README.md)**

**[Reaccionar monitor de lugares nativos](https://github.com/adobe/react-native-acpplaces-monitor/blob/master/README.md)**

**[Monitor de lugares de flutter](https://github.com/adobe/flutter_acpplaces_monitor/blob/master/README.md)**
...
1. Importe la extensión Places Monitor en la actividad principal de la aplicación.
...
## Registro y inicio del monitor de lugares {#register-start-places-monitor}
